...
> [!IMPORTANT]
> **Enterprise is not "bigger". Enterprise is "must be accountable for the future".**
...
- [Conformance & Evaluation](/docs/evaluation/conformance/index) — Technical conformance model
- [Governance Overview](/docs/evaluation/governance/index) — Protocol governance
- [Confirm Module](/docs/specification/modules/confirm-module) — Human-in-the-loop gating
- [11 Kernel Duties](/docs/specification/architecture/cross-cutting-kernel-duties/index) — Duty specifications
