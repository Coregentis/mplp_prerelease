...
> [!IMPORTANT]
> **Derived Artifact**: This document is a **mirror** of definitions found in the Protocol Repository. In case of discrepancy, the schemas and invariants in the repository are the single source of truth.
