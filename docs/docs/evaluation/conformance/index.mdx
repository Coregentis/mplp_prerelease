...
>
> - **Conformance** = Does this system match the protocol specification? (Technical)
> - **Compliance** = Does this system meet legal/regulatory requirements? (Legal)
>
> MPLP addresses **conformance** only. Legal compliance is outside our scope.
...
| Validate with Golden Flows | [Golden Flows](/docs/evaluation/golden-flows/index) |
...
- [Golden Flows](/docs/evaluation/golden-flows/index) — Lifecycle invariant validation
