...
**Package Role:** Public npm key-value storage integration helper package
**Protocol:** MPLP v1.0.0 (Frozen)
**Package version:** 1.0.6
**License:** Apache-2.0

The `@mplp/integration-storage-kv` package provides a runtime-level key-value storage integration helper for MPLP v1.0.0 consumers.

It is an integration helper surface. It is not a direct protocol object mirror and not a storage service.
...
- A key-value storage helper export such as `InMemoryKeyValueStore`.
...
```bash
npm install @mplp/integration-storage-kv
```

## Minimal User Smoke Usage Snippet

```javascript
const { InMemoryKeyValueStore } = require('@mplp/integration-storage-kv');
...
- **Package address:** [https://www.npmjs.com/package/@mplp/integration-storage-kv](https://www.npmjs.com/package/@mplp/integration-storage-kv)
- Public npm surface: `packages/npm/integration-storage-kv`.
