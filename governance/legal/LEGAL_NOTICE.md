...
No execution hosting. No certification. Evidence adjudication only.

## Links

- Apache-2.0: https://www.apache.org/licenses/LICENSE-2.0
- LICENSE: https://github.com/Coregentis/MPLP-Protocol/blob/main/LICENSE.txt
- MPGC: https://www.mplp.io/governance/overview

## Update Policy

Any changes to legal text require governance review.
Version changes logged in governance/freeze/ directory.
