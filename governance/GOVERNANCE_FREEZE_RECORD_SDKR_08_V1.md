...
|:---|:---|:---:|
| METHOD-SDKR-08 (Main) | `governance/03-sdk-release/METHOD-SDKR-08_MULTI_PACKAGE_RELEASE_GOVERNANCE.md` | **FROZEN** |
...
| Artifact | Path | Status |
|:---|:---|:---:|
| DERIVATION_PROOF Template | `governance/03-sdk-release/templates/DERIVATION_PROOF_TEMPLATE.yaml` | **FROZEN** |
| RELEASE_BUNDLE_MANIFEST Template | `governance/03-sdk-release/templates/RELEASE_BUNDLE_MANIFEST_TEMPLATE.json` | **FROZEN** |
...
- [METHOD-SDKR-08](file:///governance/03-sdk-release/METHOD-SDKR-08_MULTI_PACKAGE_RELEASE_GOVERNANCE.md)
- [MPLP Constitution](file:///governance/01-core/MPLP_CONSTITUTION.md)
- [EXECUTION_ORDER](file:///governance/EXECUTION_ORDER.md)
